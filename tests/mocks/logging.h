...
#ifndef LOGGING_H_MOCK_
#define LOGGING_H_MOCK_

#include "PmLogLib.h"

extern PmLogContext logContext;

// Mock log macros - no-ops for testing
#define BT_CRITICAL(msgid, kvcount, ...) do {} while(0)
#define BT_ERROR(msgid, kvcount, ...) do {} while(0)
#define BT_WARNING(msgid, kvcount, ...) do {} while(0)
#define BT_INFO(msgid, kvcount, ...) do {} while(0)
